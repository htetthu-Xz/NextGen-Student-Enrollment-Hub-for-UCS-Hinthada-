...
class TransferStudentExport implements FromCollection, WithMapping, WithHeadings, WithTitle, WithCustomStartCell, WithEvents, WithDrawings, WithStyles
{
    public $users;
    ...
    {
        return 'ကျောင်းပြောင်း ကျောင်းသားများစာရင်း';
    }
    ...
    public function registerEvents(): array
    {
        return [
            BeforeSheet::class => function (BeforeSheet $event) {
                $event->sheet->setCellValue('A1', 'ကွန်ပျူတာတက္ကသိုလ် (ဟင်္သာတ) ကျောင်းပြောင်း ကျောင်းသားများစာရင်း');
